        ...
        wp_add_inline_script(
            ...
            'window.pluginoraAdmin = ' . wp_json_encode(
                [
                    ...
                    'strings'  => [
                        'loading'         => __('Loading the Pluginora workspace...', 'pluginora'),
                        'loadError'       => __('Pluginora could not load the promotion workspace.', 'pluginora'),
                        'saveSuccess'     => __('Promotion rule saved successfully.', 'pluginora'),
                        'deleteConfirm'   => __('Delete this promotion rule?', 'pluginora'),
                        'cancel'          => __('Cancel', 'pluginora'),
                        'save'            => __('Save Promotion', 'pluginora'),
                        'update'          => __('Update Promotion', 'pluginora'),
                        'createRule'      => __('Create Promotion', 'pluginora'),
                        'existingRules'   => __('Promotion Library', 'pluginora'),
